...
Это значит, что **нужен механизм ускорения времени**, чтобы посмотреть, что будет через день/месяц/год и т.п. (Олег сказал, что это можно не реализовывать)
...
### Консольный интерфейс работы (Олег сказал, что это можно не реализовывать)
